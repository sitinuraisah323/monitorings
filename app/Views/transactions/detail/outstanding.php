...
console.log('initDataTable',id_unit);
          ...
          dataTable = $('#table-1').DataTable( {
                ...
                // pageLength: 25,               
                ajax:  {
                    url: `<?php echo base_url();?>/api/transactions/detail/outstanding_bydate/${id_unit}/${date}`, 
                ...
                columns: [
                    ...
                    //   },   
                      ...
                      { data: "sisa" ,
                        render: function ( data, type, row ) {  
                          if(row.product_name=='Gadai Cicilan'){
                            return convertToRupiah(row.up - row.angsuran);
                          } else{
                            return convertToRupiah(row.up);
                          }  
                        } 
                      },
                      { data: "admin" },
                  ...
                  buttons: [
                     {
                          extend: 'copy',
                          title: 'Monitoring - Data Outstanding',
