...
<section class="section">
          <div class="section-body">
            ...
            <input type="hidden" name="deviasi" id="deviasi" value="<?php echo $deviasi; ?>" />     
    ...
    <script type="text/javascript">
        ...
        const initDataTable = ()=>{
          ...
          dataTable = $('#table-1').DataTable( {
                ...
                // pageLength: 25,               
                ajax:  {
                    url: `<?php echo base_url();?>/api/transactions/fraud/detailApproval/${office_id}/${month}/${year}/${approval}/${deviasi}/${product}`, 
                ...
                columns: [
                  ...
                  buttons: [
                     {
                          extend: 'copy',
                          title: 'Monthly - Detail Deviasi & Approval',
